    ...
    <div class="content">
        ...
        <div class="marketing">
            ...
            <div class="row featurette">
              <div class="col-md-7">
                <h2 class="featurette-heading">El petróleo está por los suelos; ¿veremos el diésel y la gasolina por debajo del euro por litro?</h2>
            ...
            <div class="row featurette">
              <div class="col-md-7 order-md-2">
                <h2 class="featurette-heading">El chollo detrás del Coronavirus: oleada de coches en stock a precio de derribo</h2>
            ...
            <div class="row featurette">
              <div class="col-md-7">
                <h2 class="featurette-heading">La FIA publica los entresijos técnicos de la categoría Rally1, los futuros World Rally Cars</span></h2>
